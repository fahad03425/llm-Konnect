...
_CORE_SPECS: List[KPISpec] = [
    ...
    KPISpec("row_count", "Row Count", "rows",
            "Total count of records/rows in the dataset matching filter criteria.",
            core_kpis.row_count, tags=("volume",)),
    ...
    KPISpec("expense_breakdown_by_supplier", "Expense Breakdown by Supplier", "PKR",
            ...
            tags=("breakdown",)),
    KPISpec("revenue_breakdown_by_supplier", "Revenue Breakdown by Supplier", "PKR",
            "Sale amount grouped by supplier_id.", core_kpis.revenue_breakdown_by_supplier,
            tags=("breakdown",)),
